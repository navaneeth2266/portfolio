      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-16 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {posters.map((poster, i) => {
            const Card = poster.href ? motion.a : motion.div;
            const linkProps = poster.href
              ? { href: poster.href, target: "_blank", rel: "noopener noreferrer" }
              : {};
            ...
            return (
              <Card
                ...
                className={`group relative aspect-[4/5] overflow-hidden rounded-2xl border-4 border-ink-950 shadow-[8px_8px_0_rgba(0,0,0,0.45)] ${poster.href ? "cursor-pointer" : ""}`}
              >
                <Image
